...
<body style="font-family:Verdana; font-size: 1.2em; color:navy; background-color:darksalmon; margin-top:12%">
    <form id="form1" runat="server">
    <center>
    <div style="border: 1px solid Navy; width:50%; background-color:burlywood; box-shadow: -4px -4px 12px Navy;">
    <table cellpadding="4" width="100%">
        <tr><td align="center" valign="Top" colspan="2"> 
     <h2 style="text-shadow: 2px 2px 14px yellow;">LogIn Page</h2>
            </td></tr>
